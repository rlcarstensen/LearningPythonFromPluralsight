...
# Book.add_book("Green Eggs and Ham", 9.99, 12371287321)
# Book.get_all_books()
# Book.add_book("The Cat in the Hat", 9.99, 1237123128)
# Book.get_all_books()

# from BookModel import *
# Book.get_all_books()
# Book.get_book(12371287321)
# Book.get_book(1237123128)

# from BookModel import *
# Book.get_all_books()
# Book.delete_book(1237123128)
# Book.get_all_books()

# from BookModel import *
# Book.get_all_books()
# Book.update_book_price(12371287321, 10.99)
# Book.get_all_books()
# Book.update_book_name(12371287321, 'Green Eggs and Ham 2')
# Book.get_all_books()

# from BookModel import *
# Book.get_all_books()
# Book.replace_book(12371287321, 'Goodnight Moon', 1.99)
# Book.get_all_books()
